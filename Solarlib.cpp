...
// PS changes to compile with Arduino
#define DEG_TO_RAD 0.017453292519943295769236907684886
#define RAD_TO_DEG 57.295779513082320876798154814105

int hour(const std::time_t tt) {
    const std::tm calendar_time = *std::localtime( std::addressof(tt) ) ;
    return calendar_time.tm_hour;
}
int minute(const std::time_t tt) {
    const std::tm calendar_time = *std::localtime( std::addressof(tt) ) ;
    return calendar_time.tm_min;
}
int second(const std::time_t tt) {
    const std::tm calendar_time = *std::localtime( std::addressof(tt) ) ;
    return calendar_time.tm_sec;
}
